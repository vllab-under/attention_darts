...
from model.attention.attention_darts import _Attention_DARTS
...
class resnet(_Attention_DARTS):
  def __init__(self, classes, num_layers=101, pretrained=False, class_agnostic=False):
    self.model_path = '/home/minju_ro/data/pretrained_model/resnet101_caffe.pth'
    self.dout_base_model = 256
    self.pretrained = pretrained
    self.class_agnostic = class_agnostic

    _Attention_DARTS.__init__(self, classes, class_agnostic)

  def _init_modules(self):
    resnet = resnet101() # backbone
